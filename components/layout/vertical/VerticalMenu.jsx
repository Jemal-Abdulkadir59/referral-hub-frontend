    ...
    >
      ...
      >
        ...
        <SubMenu
          ...
          suffix={<Chip label='Pro' size='small' color='primary' variant='tonal' />}
        >
          <MenuItem href='/dashboard/list-users' icon={<i className='ri-circle-line' />}>
            List Users
          </MenuItem>
          <MenuItem href='/dashboard/register-new-user' icon={<i className='ri-circle-line' />}>
            Register User
          </MenuItem>
        </SubMenu>
        {/* <SubMenu
        ...
        <MenuSection label='Referrals Table'>
          <MenuItem href='/dashboard/referrals' icon={<i className='ri-table-line' />}>
            Referrals
          </MenuItem>
        </MenuSection>
        <MenuSection label='Patient Record Table'>
          <MenuItem href='/dashboard/patient-records' icon={<i className='ri-table-line' />}>
            Patient Records
          </MenuItem>
        </MenuSection>
        <MenuSection label='Doctors Reports Table'>
          <MenuItem href='/dashboard/doctor-reports' icon={<i className='ri-table-line' />}>
            Doctors Reports
          </MenuItem>
        </MenuSection>
        {/* <MenuSection label='Patients'>
          <MenuItem href='/dashboard/patients' icon={<i className='ri-user-line' />}>
            Patients
          </MenuItem>
        </MenuSection> */}
