...
import VerticalMenuDataClerk from './VerticalMenu-data-clerk'
...
const NavigationDataClerk = () => {
  ...
  return (
    ...
    <VerticalNav customStyles={navigationCustomStyles(theme)}>
      ...
      <VerticalMenuDataClerk scrollMenu={scrollMenu} />
    </VerticalNav>
  )
}

export default NavigationDataClerk
