...
const VerticalMenuDataClerk = ({ scrollMenu }) => {
  // Hooks
    ...
    >
      ...
      >
        ...
        <MenuSection label='Referrals Pages'>
          <MenuItem href='/data-clerk' icon={<i className='ri-file-copy-line' />}>
            Referrals
          </MenuItem>
        </MenuSection>

        <MenuSection label='Apps & Pages'>
          <MenuItem href='/data-clerk/account-settings' icon={<i className='ri-user-settings-line' />}>
            Account Settings
          </MenuItem>
        </MenuSection>
      </Menu>
...
export default VerticalMenuDataClerk
